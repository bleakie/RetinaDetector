...
config.TEST.PYRAMID_SCALES = [0.5, 1.0, 1.5]
...
network.resnet.pretrained = 'model/pretrain-model/imagenet-resnet-50/resnet-50'
...
default.pretrained = 'model/imagenet-resnet-50'
